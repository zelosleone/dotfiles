...
; Make sure numlock is turned off
  ...
  ; Bottom Left     
              ...
              !^NumpadEnd::
            WinMove,A,,     1932, 21, 529, 1010
  return  

              ; Bottom Right

  !^NumpadPgDn::
            WinMove,A,,      3586, 474, 236, 548
      return
  ...
  !^NumpadEnter::
            WinMove,A,,     1932, 21, 1897, 1008
      return

             ; Right (Second Monitor)
             !^NumpadAdd::
            WinMove,A,,       2468, 21, 1361, 1010
      return

         ; Middle top

         !^NumpadIns::
          WinMove,A,,     1932, 21, 1637, 1008
             return
